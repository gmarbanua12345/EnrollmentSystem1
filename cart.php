 <?php check_message(); ?>
 <form action="index2.php?q=subject" method="POST">
      <table class="table table-hover"> 
          ...
          <?php
           ...
           <td colspan="6">
            ...
            <tr> 
            <td colspan="7">  
              <a href="index2.php?q=subjectlist" class="btn btn-success btn-md" name="submit" type="submit">Add Another Subject</a>
            </td>
            <td >  
            ...
            <tr> 
              <td colspan="7">  
                <a href="index2.php?q=subjectlist" class="btn btn-success btn-md" name="cartsubmit" type="submit">Add Another Subject</a>
              </td>
             </tr>';
            }
          ?> 
